...
var Coin, ExitPost, Game, Ground, Hud, Map, Menu, Player,
...
Coin = (function(superClass) {
  ...
  function Coin(texture, texture_picked_up, sound) {
    ...
    var picked_up_anim;
    Coin.__super__.constructor.call(this, texture.getSubTexture(0));
    this.texture_idle = texture;
    ...
    this.addAnimation('idle', texture);
  }
  ...
  Coin.prototype.reset = function(x, y) {
    ...
    Coin.__super__.reset.apply(this, arguments);
    this.solid = true;
    return this.play('idle', true);
  };
  ...
  Coin.prototype.clone = function() {
    var c;
    c = new Coin(this.texture_idle, this.texture_picked_up, this.sound.clone());
...
ExitPost = (function(superClass) {
  ...
  ExitPost.prototype.show = function() {
    ExitPost.__super__.show.apply(this, arguments);
    if (this.is('_default')) {
...
Ground = (function(superClass) {
  extend(Ground, superClass);

  function Ground() {
    return Ground.__super__.constructor.apply(this, arguments);
  }

  Ground.prototype.clone = function() {
    return new Ground(this.texture);
  };
...
Hud = (function(superClass) {
  ...
  function Hud(w, h, sprites) {
    ...
    this.add(this.score);
    this.add(new Fz2D.Entity(sprites.getTexture('spinning_coin_gold').getSubTexture(0), w - 60, 10));
    this.exists = false;
  }
...
Player = (function(superClass) {
  ...
  Player.prototype.reset = function(x, y) {
    ...
    Player.__super__.reset.call(this, this.ox, this.oy);
    this.solid = true;
    this.dx = 0.0;
    this.dy = 0.0;
