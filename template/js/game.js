...
ExitPost = (function(_super) {
  __extends(ExitPost, _super);
...
Map = (function(_super) {
  ...
  Map.prototype.load = function(map) {
    ...
    this.clear();
    for (y = _i = 0, _ref = map.h - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; y = 0 <= _ref ? ++_i : --_i) {
      for (x = _j = 0, _ref1 = map.w - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; x = 0 <= _ref1 ? ++_j : --_j) {
